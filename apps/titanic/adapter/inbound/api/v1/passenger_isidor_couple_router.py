...
from clover.apps.titanic.app.ports.input.passenger_isidor_couple_use_case import (
    IsidorCoupleUseCase,
)
from clover.apps.titanic.dependencies.passenger_isidor_couple_provider import (
...
async def introduce_myself(
    ...
    return await isidor.introduce_myself(
        IsidorCoupleSchema(
            id=12, name="이시도르 & 이다 스트라우스 부부 (Isidor & Ida Straus)"
        )
    )
