...
from clover.apps.titanic.app.ports.input.passenger_ruth_survivor_use_case import (
    RuthValidationUseCase,
)
from clover.apps.titanic.dependencies.passenger_ruth_survivor_provider import (
...
async def introduce_myself(
    ...
    return await ruth.introduce_myself(
        RuthValidationSchema(id=14, name="루스 드윗 부카터 (Ruth DeWitt Bukater)")
    )
