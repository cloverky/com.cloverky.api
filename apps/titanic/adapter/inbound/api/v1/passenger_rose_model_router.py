...
from clover.apps.titanic.app.dtos.passenger_rose_model_dto import RoseModelResponse
from clover.apps.titanic.app.ports.input.passenger_rose_model_use_case import (
    RoseModelUseCase,
)
from clover.apps.titanic.dependencies.passenger_rose_model_provider import (
...
async def introduce_myself(
    ...
    return await rose.introduce_myself(
        RoseModelSchema(id=14, name="로즈 드윗 부카터 (Rose DeWitt Bukater)")
    )
