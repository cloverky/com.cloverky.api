...
from clover.apps.titanic.app.dtos.passenger_jack_trainer_dto import JackTrainerResponse
from clover.apps.titanic.app.ports.input.passenger_jack_trainer_use_case import (
    JackTrainerUseCase,
)
from clover.apps.titanic.dependencies.passenger_jack_trainer_provider import (
...
async def introduce_myself(
    ...
    return await jack.introduce_myself(
        JackTrainerSchema(id=13, name="잭 도슨 (Jack Dawson)")
    )
