...
from clover.apps.titanic.app.dtos.passenger_molly_scaler_dto import MollyScalerResponse
from clover.apps.titanic.app.ports.input.passenger_molly_scaler_use_case import (
    MollyScalerUseCase,
)
from clover.apps.titanic.dependencies.passenger_molly_scaler_provider import (
...
async def introduce_myself(
    ...
    return await molly.introduce_myself(
        MollyScalerSchema(id=14, name="몰리 브라운 (Molly Brown)")
    )
