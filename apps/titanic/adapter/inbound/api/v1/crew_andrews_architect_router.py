...
from clover.apps.titanic.app.dtos.crew_andrews_architect_dto import AndrewsArchitectResponse
from clover.apps.titanic.app.ports.input.crew_andrews_architect_use_case import AndrewsArchitectUseCase
from clover.apps.titanic.dependencies.crew_andrews_architect_provider import get_andrews_architect_use_case
'''
