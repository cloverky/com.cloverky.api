...
from clover.apps.titanic.app.dtos.passenger_jack_trainer_dto import JackTrainerQuery, JackTrainerResponse
from titanic.adapter.outbound.orm.passenger_rose_model_orm import BookingOrm
