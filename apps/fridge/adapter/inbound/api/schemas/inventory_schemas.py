...
from fridge.app.use_cases._shelf_life import STORAGE_CHOICES, UNIT_CHOICES
...
class InventoryExpiryEstimateResponse(BaseModel):
    name: str
    purchased_date: date
    storage: str
    shelf_life_days: int
...
class InventoryQuantityAdjustBody(BaseModel):
